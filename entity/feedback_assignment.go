...
type FeedbackAssignment struct {
	...
	AttachmentID   string `json:"attachment_id" gorm:"column:attachment_id;type:varchar(500)"`
	AttachmentName string `json:"attachment_name" gorm:"column:attachment_name;type:varchar(100)"`
