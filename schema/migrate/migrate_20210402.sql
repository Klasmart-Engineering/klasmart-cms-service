...
ALTER TABLE assessments MODIFY `program_id` VARCHAR(64) DEFAULT '' COMMENT 'DEPRECATED: program id';
ALTER TABLE assessments MODIFY `subject_id` VARCHAR(64) DEFAULT '' COMMENT 'DEPRECATED: subject id';
