...
create table `assessments` (
    ...
    `program_id` varchar(64) not null default '' comment 'DEPRECATED: program id',
    `subject_id` varchar(64) not null default '' comment 'DEPRECATED: subject id',
    `teacher_ids` json comment 'DEPRECATED: teacher ids',
