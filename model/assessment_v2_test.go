...
func TestAssessmentModel_GetByID(t *testing.T) {
	...
	op.Token = "eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImM1N2VmNjhkLWE2MzUtNDUxZC1iOTk3LWFlYmMzYzI5Yjk5YSIsImVtYWlsIjoib3JnYmFkYUB5b3BtYWlsLmNvbSIsImV4cCI6MTY0MzA5Mjg2OSwiaXNzIjoia2lkc2xvb3AifQ.tV3D9mE7y2XZZT18oQSrZ7YnbCEmzOm1WjdYL_OJPXI2wEmYzIM3By2uADG0EMe2CDWw_oBWpJTHrhS_08HaQgt67h7AuLEvF9dX5Qe2Xh3fJiut_zqEwR68sbv0UcQvi3kkqtf_vTrKEMhxwFfhpKQpJnfOnEDZ6ape9lqBxl5D-DjARiaG-fBFYpiuvBLUo1JFS48ggyzr28VQmO26Aip2d0UKA4GdK9PVOGpXOJhd8NXWqEAjDYlOzOVG6qtL8v09TWw_9xGGFayKfFtdgThzy4nCUJCKslHNy05srd_fACUIYYFmauMzpAEyYZ0SMDMX7y_0n1XkayNX179JZA"
	t.Log(op)
	result, err := GetAssessmentModelV2().GetByID(ctx, op, "619f29a6c99b2996bbcf4e48")
	if err != nil {
		t.Fatal(err)
	}
