...
type ILearningOutcomeReport interface {
	...
	GetStudentOutcome(ctx context.Context, op *entity.Operator, req entity.ListStudentsAchievementReportRequest) (items []*entity.StudentOutcome, err error)
}

func (r *ReportDA) GetStudentOutcome(ctx context.Context, op *entity.Operator, req entity.ListStudentsAchievementReportRequest) (items []*entity.StudentOutcome, err error) {
	items = []*entity.StudentOutcome{}
