...
func (s Server) registeRoute() {
	...
	schedules := s.engine.Group("/v1")
	{
		...
		schedules.GET("/schedules_filter/schools", s.mustLogin, s.getScheduleFilterSchool)
		schedules.GET("/schedules_filter/classes", s.mustLogin, s.getScheduleFilterClasses)
	}
