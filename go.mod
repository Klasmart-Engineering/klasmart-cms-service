...
require (
	github.com/KL-Engineering/chlorine v0.4.0
	...
	github.com/KL-Engineering/kidsloop-cache v0.2.0
...
require (
	...
	github.com/newrelic/go-agent/v3/integrations/nrredis-v8 v0.0.0-20220519215051-c2426dfde466 // indirect
